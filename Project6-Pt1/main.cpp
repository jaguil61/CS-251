...
int main()
{
	...
	// copy constructor
	hashmap<string, LotteryData> HT2(hmap);
	...
	while (thedate != "#")
	{
		...
		// 
    LotteryData ld;
	LotteryData ID2; // copy 

    bool found = hmap.search(thedate, ld, Hash);
	bool found2 = HT2.search(thedate, ID2, Hash); // copy 
    ...
    else
    {
	  ...
	  // copy 
	  cout << "Winning numbers: " << ID2.Numbers << endl;
      cout << "Mega ball: " << ID2.MegaBall << endl;
      cout << "Multiplier: " << ID2.Multiplier << endl;
    }
